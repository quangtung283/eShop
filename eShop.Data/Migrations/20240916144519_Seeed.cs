    ...
    public partial class Seeed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 9, 16, 21, 45, 18, 933, DateTimeKind.Local).AddTicks(8081), null, 100000m, 200000m });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName" },
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "088d76f7-d836-43e2-8c75-8384994f2e0c", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "9645bca8-3204-40e4-b39c-36a1c29b3dcc", new DateTime(2024, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "quangtung2832002fpt@gmail.com", true, "Quang", "tung", false, null, "quangtung2832002fpt@gmail.com", "admin", "AQAAAAEAACcQAAAAEJ6GY5KpyH2qXReW9a5vuUh8gFrF9HkfFRtTSrmzOgcOcFjghOl6fUG23p4ADsrEaQ==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "CategoyId", "ProductId" },
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "ProductInCategories",
                keyColumns: new[] { "CategoyId", "ProductId" },
