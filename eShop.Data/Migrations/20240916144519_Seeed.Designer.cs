...
namespace eShop.Data.Migrations
{
    ...
    [Migration("20240916144519_Seeed")]
    partial class Seeed
    {
            ...
            modelBuilder.Entity("eShop.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 9, 16, 21, 45, 18, 933, DateTimeKind.Local).AddTicks(8081),
            ...
            modelBuilder.Entity("eShop.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "088d76f7-d836-43e2-8c75-8384994f2e0c",
            ...
            modelBuilder.Entity("eShop.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9645bca8-3204-40e4-b39c-36a1c29b3dcc",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJ6GY5KpyH2qXReW9a5vuUh8gFrF9HkfFRtTSrmzOgcOcFjghOl6fUG23p4ADsrEaQ==",
            ...
            modelBuilder.Entity("eShop.Data.Entities.Cart", b =>
                {
                    ...
                    b.HasOne("eShop.Data.Entities.User", "AppUser")
                        .WithMany("Carts")
