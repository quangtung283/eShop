...
namespace eShop.Data.DataSeeding
{
        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
           ...
           new Product()
           {
            ...
            modelBuilder.Entity<ProductInCategory>().HasData(
                new ProductInCategory() { ProductId = 1, CategoyId = 1 }
                );
            ...
            modelBuilder.Entity<User>().HasData(new User
            {
                ...
                Email = "quangtung2832002fpt@gmail.com",
                NormalizedEmail = "quangtung2832002fpt@gmail.com",
                EmailConfirmed = true,
