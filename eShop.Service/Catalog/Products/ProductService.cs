    ...
    public class ProductService : IProductService
    {
        ...
        public async Task<PagedResult<ProductVm>> GetAllPaging(GetManageProductPagingRequest request)
        {
            ...
            var query = from p in _context.Products
                        ...
                        join c in _context.Categories on pic.CategoyId equals c.Id into picc
        ...
        public async Task<ProductVm> GetById(int productId, string languageId)
        {
            ...
            var categories = await (from c in _context.Categories
                                    ...
                                    join pic in _context.ProductInCategories on c.Id equals pic.CategoyId
        ...
        public async Task<ApiResult<bool>> CategoryAssign(int id, CategoryAssignRequest request)
        {
            ...
            foreach (var category in request.Categories)
            {
                var productInCategory = await _context.ProductInCategories
                    .FirstOrDefaultAsync(x => x.CategoyId == int.Parse(category.Id)
                    && x.ProductId == id);
                ...
                else if (productInCategory == null && category.Selected)
                {
                    ...
                    {
                        CategoyId = int.Parse(category.Id),
                        ProductId = id
                    });
                }
            }
